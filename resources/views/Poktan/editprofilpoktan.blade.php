    ...
    <div class="w-full h-full flex flex-col bg-gray-50">
        ...
        <div class="flex h-full w-auto mt-16 ml-64">
            <div class="flex flex-col mx-24 w-full items-right">
                <form class="w-full">
                    <div class="flex mb-8">
                        <label for="nama_petani" class="block text-gray-900 font-bold w-1/3">Nama Poktan</label>
                    ...
                    <div class="flex mb-8">
                        <label for="ttl_petani" class="block text-gray-900 font-bold w-1/3">Alamat Poktan</label>
                    ...
                    <div class="flex mb-8">
                        <label for="nik" class="block text-gray-900 font-bold w-1/3">No. Telepon</label>
