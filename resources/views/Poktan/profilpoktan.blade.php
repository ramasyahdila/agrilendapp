            ...
            <div class="flex flex-col mx-24 w-full items-right">
                <form class="w-full">
                    <div class="flex mb-8">
                        ...
                        <input type="text" id="nama_poktan" class="appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight shadow-md focus:outline-none focus:shadow-outline" placeholder="Siapa Gituu">
                    </div>
                    <div class="flex mb-8">
                        <label for="alamat_poktan" class="block text-gray-900 font-bold w-1/3">Alamat Poktan</label>
                        <input type="text" id="alamat_poktan" class="appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight shadow-md focus:outline-none focus:shadow-outline" placeholder="Poktan@gmail.com">
                    </div>
                    <div class="flex mb-8">
                        <label for="no_telp" class="block text-gray-900 font-bold w-1/3">No. Telepon</label>
                        <input type="text" id="no_telp" class="appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight shadow-md focus:outline-none focus:shadow-outline" placeholder="Poktan Melati">
                    </div>
                    <div class="flex mb-8">
