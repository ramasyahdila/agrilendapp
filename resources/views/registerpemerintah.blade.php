...
<body class="flex flex-col h-screen">
    ...
    <div class="flex h-auto z-0 pt-16">
        <div class="w-1/3 h-screen bg-cover bg-center" style="background-image: url(img/LoginPage.jpg)"></div>
            ...
            <div class="w-2/3 bg-transparent p-8 m-auto rounded-lg z-10">
                ...
                <form action="save_registration.php" method="post" class="flex flex-col items-center">
                    ...
                    <div class="mb-4 w-full">
                        ...
                        <input type="text" id="nama_pemerintah" class="shadow-lg appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Tulis nama pemerintahan">
                    </div>
                    <div class="mb-4 w-full">
                        <label for="password" class="block text-white font-bold mb-2">Alamat Pemerintah</label>
                        <input type="text" id="alamat_pemerintah" class="shadow-lg appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan Alamat Anda">
                    </div>
                    <div class="mb-4 w-full">
